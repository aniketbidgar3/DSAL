...
class tree{
	public:
		...
		node* create(){
			string key;
			cout<<"Enter the book(if not enter 'n'):";
			cin>>key;
			if(key=="n"){
			    return NULL;
			}
	...
	while(1){
		...
		switch(ch){
			case 1:
				...
				break;
			case 2:
            cout<<"Inorder sequence using Recursion           : ";
				t.inorder(t.root);
				break;
			case 3:
            cout<<"Preorder sequence using Recursion          : ";
			    t.preorder(t.root);	
			    break;
			case 4:
            cout<<"Postorder sequence using Recursion         : ";
			    t.postorder(t.root);
			    break;
			case 5:
            cout<<"Inorder sequence without using Recursion   : ";
			    t.nonrecursive_inorder(t.root);
			    break;
			case 6:
            cout<<"Preorder sequence without using Recursion  : ";
			    t.nonrecursive_preorder(t.root);
			    break;
			case 7:
            cout<<"Postorder sequence without using Recursion : ";
			    t.nonrecursive_postorder(t.root);
			    break;
			case 8:
            cout<<"Breadth First Search using Recursion       : ";
			    t.BFS(t.root);
			    break;
			case 9:
			    exit(1);
